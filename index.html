...
.wrapper { width: 300px; margin: 30px auto; position: center;}
...
.fa-2x { margin: 0 auto; float: none; display: table; color: #8C163F; }
...
<div class="wrapper">
    ...
    <div class="counter col_third">
      ...
      <h2 class="timer count-title count-number" data-to="9" data-speed="1600"></h2>
